        ...
        <?php foreach ($site->newsCard()->toStructure() as $item) : ?>
          <div class="newscards__card">
            <div class="newscards__card__header">
              ...
              <div class="newscards__card__header__dateButton">
                <iconify-icon icon="lets-icons:date-today-light" style="color: #053f41;margin-right: 5px;" width="20"
                              height="20"></iconify-icon><?= $item->cardDate() ?></div>
