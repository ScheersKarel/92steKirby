<?php snippet('head', ['title' => 'Steentje']); ?>
...
<div class="container">
  ...
  <div class="content">
    ...
    <div class="steentje">
      <iframe id="iframe" class="scribd_iframe_embed" title="Steentje " src="<?= $page->steentje() ?>" tabindex="0"
              data-auto-height="true" data-aspect-ratio="0.7068965517241379" scrolling="no" width="100%" height="600"
